...
const StepConnector = () => (
  ...
  >
    ...
    <circle cx="2" cy="10" r="2" fill="#D1D5DB" />
    <circle cx="2" cy="18" r="2" fill="#D1D5DB" />
  </svg>
);

const stepsName = ["Titre & Date", "Lieu", "Détails", "Budget"];
                    ...
                    <li className="relative" key={idx}>
                      {steps === idx ? (
                        <div className="flex w-full items-center justify-start gap-4 rounded-full bg-b50 p-2">
                          ...
                          <p className="text-sm font-medium">Titre & Date</p>
                        </div>
                      ) : (
                        <div
                      ...
                      {stepsName.length !== idx + 1 && <StepConnector />}
                    </li>
                  ))}
                </ul>
              </div>
