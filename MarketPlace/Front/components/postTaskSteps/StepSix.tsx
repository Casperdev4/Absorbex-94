    ...
    <div className="sbp-30 container grid grid-cols-12 pt-20">
      <div className="col-span-12 rounded-2xl border border-n30 p-4 sm:p-10 md:col-span-8 md:col-start-3 xxl:col-span-6 xxl:col-start-4">
        <h4 className="heading-4 flex items-center justify-center gap-2">
          <PiCaretLeftBold /> Créez votre compte
        </h4>

        <div className="flex flex-col gap-4 pt-6 sm:gap-6 lg:pt-10">
          <div className="">
            <p className="pb-4">Prénom *</p>
            <input
              type="text"
          ...
          <div className="">
            <p className="pb-4">Entrez votre ville *</p>
            <input
              type="text"
              className="w-full rounded-xl bg-n30 p-3 outline-none"
            />
          ...
          <div className="">
            <p className="pb-4">Quel est votre objectif principal sur Servibe ? *</p>
            <div className="flex w-full items-center justify-start font-medium max-sm:flex-wrap">
              {["Poster une mission", "Gagner de l'argent"].map((item, idx) => (
                <button
          ...
          <div className="flex items-center justify-start gap-3">
            ...
            <p className="text-sm text-n300">
              J&apos;accepte de recevoir des mises à jour, des offres marketing et
              des promotions par email, SMS et notifications push
            </p>
          </div>
          ...
          <div className="flex items-center justify-start gap-3">
            ...
            <p className="text-sm text-n300">
              ...
              , les Règles de la Communauté et la{" "}
        ...
        <div className="w-full pt-10">
          ...
          >
            <span className="relative z-10">Finaliser mon compte</span>
          </Link>
        </div>
      </div>
    </div>
