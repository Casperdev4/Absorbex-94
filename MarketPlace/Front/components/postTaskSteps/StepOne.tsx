...
function StepOne() {
  ...
  return (
    <div className="">
      <h4 className="heading-4">Commençons par les bases</h4>
      <p className="pb-4 pt-6 lg:pt-10">
        En quelques mots, de quoi avez-vous besoin ?*
      </p>
      <input
        type="text"
      ...
      <div className="flex flex-wrap items-center justify-start gap-2">
        <div className="">
          <p className="pb-3 font-semibold">Le</p>
          <input
            type="date"
        ...
        <div className="">
          <p className="pb-3 font-semibold">Avant le</p>
          <input
            type="date"
            className="rounded-full border border-n900 px-4 py-3 outline-none"
          />
        ...
        <div className="">
          <p className="pb-3 font-semibold">N&apos;importe quand</p>
      ...
      <div className="flex items-center justify-start gap-2 pb-6 pt-6 font-medium lg:pb-10">
        <input type="checkbox" />
        <p>J&apos;ai besoin d&apos;un créneau horaire précis</p>
      </div>
